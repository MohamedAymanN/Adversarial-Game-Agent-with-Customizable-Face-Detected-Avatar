#ifndef TOURNAMENT_PLAY_SCREEN_H
#define TOURNAMENT_PLAY_SCREEN_H
...
class Tournament_Play_Screen : public Game_Screen
{
    public:
        Tournament_Play_Screen(std::string img_loc_p1,std::string img_loc_p2,int p1_score=0,int p2_score=0);
        ~Tournament_Play_Screen();
        void LoadContent();
        void UnloadContent();
...
#endif // TOURNAMENT_PLAY_SCREEN_H
