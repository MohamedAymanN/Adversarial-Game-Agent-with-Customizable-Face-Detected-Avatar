#ifndef SINGLEP_CHARSELECT_SCREEN_H
#define SINGLEP_CHARSELECT_SCREEN_H
#include "Game_Screen.h"


class SingleP_CharSelect_Screen : public Game_Screen
{
    public:
        SingleP_CharSelect_Screen();
        ~SingleP_CharSelect_Screen();
        void LoadContent();
        void UnloadContent();
...
#endif // SINGLEP_CHARSELECT_SCREEN_H
