#ifndef CAMPAIGN_PLAY_SCREEN_H
#define CAMPAIGN_PLAY_SCREEN_H
...
class Campaign_Play_Screen : public Game_Screen
{
    public:
        Campaign_Play_Screen(std::string img_loc);
        ~Campaign_Play_Screen();
        void LoadContent();
        void UnloadContent();
    ...
    private:
        ...
        std::string AI_images[4]={"Images/random_icon.png","Images/greedy_icon.png","Images/limited_icon.png","Images/ai_terminator.png"};
