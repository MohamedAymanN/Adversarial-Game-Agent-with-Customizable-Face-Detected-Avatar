#ifndef MULTIP_CHARSELECTP2_SCREEN_H
#define MULTIP_CHARSELECTP2_SCREEN_H
#include "Game_Screen.h"


class MultiP_CharSelectP2_Screen : public Game_Screen
{
    public:
        MultiP_CharSelectP2_Screen(std::string img_loc);
        ~MultiP_CharSelectP2_Screen();
        void LoadContent();
        void UnloadContent();
...
#endif // MULTIP_CHARSELECTP2_SCREEN_H
