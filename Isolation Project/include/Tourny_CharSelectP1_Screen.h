#ifndef TOURNY_CHARSELECTP1_SCREEN_H
#define TOURNY_CHARSELECTP1_SCREEN_H
#include "Game_Screen.h"


class Tourny_CharSelectP1_Screen : public Game_Screen
{
    public:
        Tourny_CharSelectP1_Screen();
        ~Tourny_CharSelectP1_Screen();
        void LoadContent();
        void UnloadContent();
...
#endif // TOURNY_CHARSELECTP1_SCREEN_H
