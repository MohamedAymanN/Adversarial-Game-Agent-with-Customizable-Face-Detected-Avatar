...
*/
MultiP_CharSelectP1_Screen::MultiP_CharSelectP1_Screen(){}

MultiP_CharSelectP1_Screen::~MultiP_CharSelectP1_Screen(){}

void MultiP_CharSelectP1_Screen::LoadContent(){
...
void MultiP_CharSelectP1_Screen::UnloadContent(){}

void MultiP_CharSelectP1_Screen::Update(sf::RenderWindow &window,sf::Event event){
    ...
    if(inp.mouse_left_clicked()){
        ...
        if((back_btn_sprite).getGlobalBounds().contains(mouse)){
            ...
            Screen_Manager::GetInst().addscreen(new MultiP_CharSelectP2_Screen("Images/pf1"));
        }else if((kim_player_sprite).getGlobalBounds().contains(mouse)){
            Screen_Manager::GetInst().addscreen(new MultiP_CharSelectP2_Screen("Images/kim_player"));
        }else if((putin_player_sprite).getGlobalBounds().contains(mouse)){
            Screen_Manager::GetInst().addscreen(new MultiP_CharSelectP2_Screen("Images/putin_player"));
        }else if((sadam_player_sprite).getGlobalBounds().contains(mouse)){
            Screen_Manager::GetInst().addscreen(new MultiP_CharSelectP2_Screen("Images/sadam_player"));
        }else if((sharron_player_sprite).getGlobalBounds().contains(mouse)){
            Screen_Manager::GetInst().addscreen(new MultiP_CharSelectP2_Screen("Images/sharon_player"));
        }else if((trump_player_sprite).getGlobalBounds().contains(mouse)){
            Screen_Manager::GetInst().addscreen(new MultiP_CharSelectP2_Screen("Images/trump_player"));
        }
    }

}

void MultiP_CharSelectP1_Screen::Draw(sf::RenderWindow &window){
